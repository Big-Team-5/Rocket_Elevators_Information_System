class ElevatorsController < ApplicationController
  ...
  private
    ...
    def elevator_params
      params.require(:elevator).permit(:columnId, :serial_number, :model, :type, :status, :date_of_commissioning, :date_of_last_inspection, :certificate_of_inspection, :information, :notes)
    end
end
