class BatteriesController < ApplicationController
  ...
  private
    ...
    def battery_params
      params.require(:battery).permit(:buildingId, :Type, :Status, :EmployeeId, :date_of_commissioning, :date_of_last_inspection, :certificate_of_operations, :information, :notes)
    end
end
